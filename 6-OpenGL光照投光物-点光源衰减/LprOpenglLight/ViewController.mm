...
- (void)initProgrameAndVBO
{
    ...
    materialLightConstantLocation = glGetUniformLocation(lprProgram, "light.constant");
    materialLightLinearLocation = glGetUniformLocation(lprProgram, "light.linear");
    materialLightQuadraticLocation = glGetUniformLocation(lprProgram, "light.quadratic");
    materialLightDirectionLocation = glGetUniformLocation(lprProgram, "light.direction");
    materialLightCutOffLocation = glGetUniformLocation(lprProgram, "light.cutOff");
    materialLightOuterCutOffLocation = glGetUniformLocation(lprProgram, "light.outerCutOff");
...
//    glUniformMatrix4fv(lprModelLocation, 1, GL_FALSE, glm::value_ptr(modelT));
    ...
    glUniform3f(materialLightPositionLocation, lightPosI.x, lightPosI.y,lightPosI.z);
    ...
    glUniform3f(materialLightDirectionLocation, 0.0f,0.0f,-3.0f);
    glUniform1f(materialLightCutOffLocation, glm::cos(12.5f));
    glUniform1f(materialLightOuterCutOffLocation, glm::cos(17.5f));
    glUniform1f(materialLightConstantLocation, 1.0f);
    glUniform1f(materialLightLinearLocation, 0.09f);
    glUniform1f(materialLightQuadraticLocation, 0.032f);
