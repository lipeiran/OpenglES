...
- (void)_initShader
{
    ...
    NSString *ssP = [[NSBundle mainBundle]pathForResource:@"stencil_single_color.fs" ofType:nil];
    self.ourShader = new Shader([vsP UTF8String], [fsP UTF8String]);
    self.singleShader = new Shader([vsP UTF8String],[ssP UTF8String]);
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    self.singleShader->setMat4("view", viewT);
    self.singleShader->setMat4("projection", projectionT);
...
//    glStencilMask(0x00);
    ...
    self.singleShader->setMat4("model", modelT);
    glDrawArrays(GL_TRIANGLES, 0, 36);
    modelT = glm::mat4();
    modelT = glm::translate(modelT, glm::vec3(2.0f, 0.0f, 0.0f));
    modelT = glm::scale(modelT, glm::vec3(scale, scale, scale));
